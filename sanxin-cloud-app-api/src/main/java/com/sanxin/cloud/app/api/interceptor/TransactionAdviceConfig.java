...
public class TransactionAdviceConfig {
    // 配置切面
    private static final String AOP_POINTCUT_EXPRESSION = "(execution(* com.sanxin.cloud.app.api.service..*.*(..)) or execution(* com.sanxin.cloud.app.api.task..*.*(..)) or execution(* com.sanxin.cloud.service..*.*(..)))";

...
public class TransactionAdviceConfig {
    // 配置切面
    private static final String AOP_POINTCUT_EXPRESSION = "(execution(* com.sanxin.cloud.netty.properties..*.*(..)) or execution(* com.sanxin.cloud.netty.service..*.*(..)) or execution(* com.sanxin.cloud.service..*.*(..)))";

...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        String packageName = "com.sanxin.cloud";
        boolean serviceNameStartWithI = false;//auth -> UserService, 设置成true: auth -> IUserService
        generateByTables(false, packageName, "arno", "powerplus", "sys_roles");
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String author, String database, String... tableNames) {
        ...
        String dbUrl = "jdbc:mysql://183.60.136.220:3306/" + database + "?useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false";
        ...
        String projectPath = System.getProperty("user.dir")+"/sxbbc-common-core";
